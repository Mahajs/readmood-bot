...
function buildStartMessage() {
  return [
    "<b>Привет. Я ReadMoodBot.</b>",
    "Помогаю подобрать книгу под твое состояние: <i>настроение, жанр, атмосферу и темп</i>.",
...
async function handleHelp(bot, chatId) {
  ...
  await bot.sendMessage(
    ...
    [
      "<b>Что я умею</b>",
      "📖 <b>Подобрать книгу</b> — если хочется найти чтение под настроение, атмосферу и темп.",
      "🎲 <b>Удиви меня</b> — если хочется случайной, но все еще продуманно выбранной книги из базы.",
      "📚 <b>Найти книгу</b> — если ты уже знаешь автора или название и хочешь воспользоваться /find.",
      "👤 <b>Карточки книг и кнопка «Об авторе»</b> — чтобы быстро перейти от рекомендации к самой книге и дальше к контексту автора.",
